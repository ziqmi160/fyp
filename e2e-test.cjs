...
// Test Configuration
const TEST_ACCOUNTS = {
  student: { email: 'ahmad@student.edu.my', password: 'password' },
  supervisor: { email: 'john.smith@staff.edu.my', password: 'password' },
  coordinator: { email: 'admin@fyp.edu.my', password: 'password' }
};
