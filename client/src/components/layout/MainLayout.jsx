  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 lg:ml-64">
        <header className="sticky top-0 z-30 h-16 bg-card border-b shadow-sm flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-1 w-48 py-1 bg-white rounded-lg shadow-lg border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition">
